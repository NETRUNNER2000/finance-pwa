...
const links = [
	...
	},
	{
		...
		icon: (
			...
			>
				<path
					d='M8.84 1.804a.5.5 0 00-.68-.27l-.83.38a5.46 5.46 0 00-1.66 0l-.83-.38a.5.5 0 00-.68.27l-.5 1.03a5.47 5.47 0 00-1.17 1.17l-1.03.5a.5.5 0 00-.27.68l.38.83a5.46 5.46 0 000 1.66l-.38.83a.5.5 0 00.27.68l1.03.5c.33.46.71.84 1.17 1.17l.5 1.03a.5.5 0 00.68.27l.83-.38a5.46 5.46 0 001.66 0l.83.38a.5.5 0 00.68-.27l.5-1.03c.46-.33.84-.71 1.17-1.17l1.03-.5a.5.5 0 00.27-.68l-.38-.83a5.46 5.46 0 000-1.66l.38-.83a.5.5 0 00-.27-.68l-1.03-.5a5.47 5.47 0 00-1.17-1.17l-.5-1.03zM7.5 9.5A2 2 0 107.5 5.5a2 2 0 000 4z'
					fill='currentColor'
				/>
			</svg>
		),
